...
if __name__ == '__main__':
    ...
    # certified metrics for top 10 occupations and top 10 states
    ...
    # write to output the certified metrics for top 10 occupations
    ...
    # write to output the certified metrics for top 10 states
